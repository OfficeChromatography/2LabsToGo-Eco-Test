...
# Add columns
addColumn1 = "ALTER TABLE finecontrol_method_db ADD COLUMN created_at datetime"
addColumn2 = "ALTER TABLE finecontrol_method_db ADD COLUMN updated_at datetime"
