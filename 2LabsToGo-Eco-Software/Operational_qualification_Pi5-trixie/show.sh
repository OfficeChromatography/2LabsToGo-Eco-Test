...
yes | sudo chmod 666 /dev/ttyAMA2
#yes | sudo chmod +x *.py
...
rpicam-still -t 5000 -o vis.jpg #image saved in folder 2LabsToGo-Software/Operational_qualification
python3 white-LED-off.py
echo""

python3 uv265_on.py
rpicam-still -t 5000 -o uv265.jpg
python3 uv265_off.py

python3 uv365_on.py
rpicam-still -t 5000 -o uv365.jpg
